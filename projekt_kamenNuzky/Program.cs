...
while (pokracovani)
{
    ...
    Console.WriteLine($"Nepřítel: {Hra.SkoreProtiHrac}");
    Console.WriteLine("------------");
...
overeni:
    ...
    else if (volby[volbaHrace] == "kámen" && volby[volbaNepritel] == "papír")
    {
        ...
        Hra.SkoreProtiHrac = Hra.SkoreProtiHrac + 1;
    }
    ...
    {
        Console.WriteLine($"Nepřítel vyhrál - zvolil {volby[volbaNepritel]}");
        Hra.SkoreProtiHrac = Hra.SkoreProtiHrac + 1; Hra.SkoreProtiHrac = +1;
    }
    ...
    if (Hra.SkoreHrac > 4 | Hra.SkoreProtiHrac > 4)
    {
        pokracovani = false;
    }
}

if (Hra.SkoreHrac > Hra.SkoreProtiHrac)
{
    Console.WriteLine();
